...
// Functions to get the Total Teachers from the school
...
function getClassById($conn, $classId) {
    ...
    // Gets teachers assigned to this class
...
if(!isset($_GET['class_id']) || empty($_GET['class_id'])) {
    // Redirects if no class_id provided
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <p>
                            ...
                            <?php echo $classDetails['student_count']; ?> / 5
                            <?php if ($classDetails['student_count'] >= 5): ?>
                                <span class="capacity-indicator capacity-full">FULL</span>
                            <?php else: ?>
                                <span class="capacity-indicator capacity-available">
                                    <?php echo 5 - $classDetails['student_count']; ?> SPACES LEFT
                                </span>
                            <?php endif; ?>
                        </p>
                    </div>
